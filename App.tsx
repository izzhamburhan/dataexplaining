  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] text-[#121212] flex flex-col">
      ...
      <main className="flex-grow overflow-hidden">
        {!activeLesson ? (
          <div className="max-w-6xl mx-auto px-8 py-20 h-full overflow-y-auto">
              ...
              {recommendation && isPersonalizationOn && (
                <div className="mt-12 p-10 bg-emerald-50 border border-emerald-100 animate-in fade-in slide-in-from-left-4 duration-500 relative overflow-hidden">
                  ...
                  <div className="flex flex-col space-y-4">
                    <span className="text-[10px] font-mono font-bold text-emerald-600 uppercase tracking-[0.3em]">Personalized Path Recommendation</span>
          ...
          <div className="flex h-full">
            <aside className="w-64 border-r border-black/5 bg-[#F9F8F6] shrink-0 p-8">
            ...
            <div className="w-[450px] shrink-0 border-r border-black/5 bg-white overflow-y-auto p-12">
              <div className="mb-12">
            ...
            <div className="flex-grow flex items-center justify-center p-12 bg-[#FDFCFB]">
