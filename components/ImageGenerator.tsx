      ...
      <div className="flex flex-col space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            ...
            {userContext && (
              <span className="text-[7px] font-mono text-emerald-600 font-bold uppercase tracking-widest mt-0.5">
        ...
        >
          {isLoading ? (
            <span className="animate-pulse flex items-center">
              <svg className="animate-spin -ml-1 mr-3 h-4 w-4 text-[#2A4D69]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        {imageUrl && !isLoading && (
          <div className="mt-4 group relative overflow-hidden border border-black/5 shadow-2xl rounded-sm">
            <img 
              src={imageUrl} 
              alt={modelName} 
